...
int main (int argv, char **argc) {
	...
	double Mcl = 1000000;			//Total mass of the cluster, only used when N is set to 0, necessary for usage of maximum stellar mass relation of Weidner & Kroupa (2006)
	int profile = 1;				//Density profile; =0 Plummer model, =1 King model (based on king0.f by D.C. Heggie), =2 mass segregated Subr model (Subr et al. 2007), =3 2-dimensional EFF template (Elson, Fall & Freeman 1987) or Nuker template (Lauer et al. 1995), =-1 no density gradient
	double W0 = 10;				//King's W0 paramter [0.3-12.0]
	...
	double Rh = 10;				//Half-mass radius [pc], ignored if profile = 3, set =-1 for using Marks & Kroupa (2012) Mcl-Rh relation
	...
	double RG[3] = {0.0,0.0,0.0}; //Initial Galactic coordinates of the cluster [pc]
	double VG[3] = {0.0,0.0,0.0};  //Initial velocity of the cluster [km/s]
	...
	double mlow = 0.2;				//Lower mass limit for mfunc = 1 & mfunc = 4
	...
	double Z = 0.0004;				//Metallicity [0.0001-0.03, 0.02 = solar]
	...
	char output[200]; 
	strcpy(output, "test");   		//Name of output files
